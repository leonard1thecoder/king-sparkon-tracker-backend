		...
		return http
				...
				.authorizeHttpRequests(authorize -> {
					...
					authorize
							...
							.requestMatchers(HttpMethod.POST, "/api/dev-hub/requests").permitAll()
							...
							.requestMatchers(HttpMethod.GET, "/api/dev-hub/requests", "/api/dev-hub/requests/**").hasAnyAuthority(ownerAuthority, adminAuthority)
							.requestMatchers(HttpMethod.PATCH, "/api/dev-hub/requests/**").hasAnyAuthority(ownerAuthority, adminAuthority)
