		...
		return http
				...
				.authorizeHttpRequests(authorize -> {
					...
					authorize
							...
							.requestMatchers(HttpMethod.GET, "/api/dev-hub/requests", "/api/dev-hub/requests/**").hasAuthority(adminAuthority)
							.requestMatchers(HttpMethod.PATCH, "/api/dev-hub/requests/**").hasAuthority(adminAuthority)
