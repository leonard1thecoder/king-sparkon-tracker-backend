...
public final class TicketDtos {
    ...
    public record CreateEventRequest(
            ...
            String bannerUrl,
            @NotNull TicketEventStatus status,
            @Valid @NotEmpty List<EventTicketTypeRequest> ticketTypes
    ) {}
    ...
    public record UpdateEventRequest(
            ...
            @Valid List<EventTicketTypeRequest> ticketTypes
    ) {}
    ...
    public record TicketWithdrawalRequest(
            @NotBlank String ownerId,
    ...
    public record TicketPaymentResponse(
            ...
            BigDecimal checkoutServiceFeeAmount,
    ...
    public record TicketPurchaseResponse(
            ...
            List<UserTicketResponse> tickets
    ) {}

    public record TicketVerificationResponse(
            boolean valid,
            String message,
            UserTicketResponse ticket,
            TicketEventResponse event
    ) {}

    public record OwnerTicketDashboardResponse(
            long totalEvents,
            long upcomingEvents,
            int totalCapacity,
            int totalSold,
            ...
            long vvipSold,
            BigDecimal revenue,
            BigDecimal availableWithdrawalBalance,
            BigDecimal ticketWithdrawalFeePercent
    ) {}

    public record TicketWithdrawalResponse(
            String id,
            String ownerId,
