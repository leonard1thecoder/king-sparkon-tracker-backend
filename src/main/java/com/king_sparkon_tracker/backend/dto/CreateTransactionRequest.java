...
public record CreateTransactionRequest(
		...
		@Schema(description = "Customer payment or returnable-reference email.", example = "customer@example.com") @Email @Size(max = 255) String paymentEmail,
	...
	public CreateTransactionRequest(
		...
		this(type, null, null, employeeId, ownerId, items);
	}
}
